...
class Bot(commands.Bot):
    ...
    async def on_message(self, message: discord.Message):
        if message.channel.id == bot.natsuki_thread_id:
            print("caught msg")
...
bot.natsuki_thread_id = THREAD_ID # (Thread For storing messages)
...
async def set_thread(ctx, thread_id):
    bot.natsuki_thread_id =  int(thread_id)
